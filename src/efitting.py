...
def Moffat(data , FWHM , b , e , x0 , y0 , x , y ):
...
def lnlike(theta , I , x , y):
    ...
    FWHM , b , e , x0 , y0 = theta
    model = Moffat(I , FWHM , b, e , x0 , y0 , x ,y)
    inv_sigma2 = 1.
...
def fitting_centroid(I):
    ...
    results = op.minimize(nll , [FWHM_true , b_true , e_true , x0_true , y0_true] , args = (I , x , y))
    FWHM_ml , b_ml , e_ml , x0_ml , y0_ml = results["x"]
