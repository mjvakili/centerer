...
Assuming uncorrelated Gaussian error $\sigma_{m}$ for each observable $f_{m}$, elements
...
the model paramters are the centroid coordinates. Therefore, $\mathcal{F}$
...
For PSF profiles with shorter tails (\eg Gaussian), the prefactor of 0.685 in (\ref{crlbmoffat}) becomes smaller. 
