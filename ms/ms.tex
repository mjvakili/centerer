...
estimators has been tested in specific limits where the centroiding bias is 
...
\item{{\bf Centroiding via fitting a correct PSF profile}} \quad 
...
But because this is done through a chi-squared fitting, 
